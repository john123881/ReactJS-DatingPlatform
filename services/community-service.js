...
export const CommunityService = {
  ...
  getPosts: (page = 1, limit = 12) =>
    apiClient(`/community/posts?page=${page}&limit=${limit}`),
  ...
  uploadPostPhoto: (formData) =>
    apiClient.post('/community/upload-photo', formData, {
      headers: { 'Content-Type': undefined },
    }),
  updatePostPhoto: (formData) =>
    apiClient.put('/community/edit-post-photo', formData, {
      headers: { 'Content-Type': undefined },
    }),
  ...
  getEventDetail: (eventId) =>
    apiClient(`/community/get-event-page/${eventId}`),
  ...
  uploadEventPhoto: (formData) =>
    apiClient.post('/community/upload-event-photo', formData, {
      headers: { 'Content-Type': undefined },
    }),
  updateEventPhoto: (formData) =>
    apiClient.put('/community/edit-event-photo', formData, {
      headers: { 'Content-Type': undefined },
    }),
  ...
  checkPostStatus: (userId, postIds) =>
    apiClient(
      `/community/check-post-status?userId=${userId}&postIds=${postIds}`,
    ),
  ...
  followUser: (userId, FollowingId) =>
    apiClient.post('/community/follow', { userId, FollowingId }),
  unfollowUser: (userId, FollowingId) =>
    apiClient.delete('/community/unfollow', { body: { userId, FollowingId } }),
};
