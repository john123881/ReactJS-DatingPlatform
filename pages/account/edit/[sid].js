  ...
  const handleFileChange = async (e) => {
    ...
    if (file) {
      ...
      if (file.size > 1024 * 1024) {
        toast.error('文件大小不能超過1MB', { duration: 1500 });
        return;
      }
      // 檢查文件類型是否為JPEG或PNG
      if (!['image/jpeg', 'image/png'].includes(file.type)) {
        toast.error('文件類型必須是JPG、JPEG或PNG', { duration: 1500 });
        return;
      }
    }
                      ...
                      <div className="flex flex-row items-center justify-center mx-4 lg:justify-start mb-7">
                        ...
                        <div className="relative flex flex-col basis-1/2 lg:basis-2/3">
                          <input
                            ...
                            onChange={handleChange}
                            onBlur={handleBlur}
                            className="max-w-xs basis-1/2 lg:basis-2/3 input-sm input input-bordered max-h-[32px] min-h-[32px]"
                          />
                        </div>
                      </div>
                      <div className="flex flex-row items-center justify-center mx-4 lg:justify-start mb-7">
                          ...
                          <input
                            ...
                            className={`${
                              errors.birthday && touched.birthday
                                ? 'border-red-500 '
                                : ''
                            } max-w-xs min-w-[180px] sm:min-w-[150px] cursor-pointer lg:min-w-[180px] basis-1/2 sm:basis-1/2 lg:basis-2/3 input input-sm input-bordered  max-h-[32px]`}
                          />
                          {errors.birthday && touched.birthday && (
                            <p className="absolute bottom-[-20px] mx-4 text-red-500 basis-full lg:justify-start text-[12px]">
                              {errors.birthday}
