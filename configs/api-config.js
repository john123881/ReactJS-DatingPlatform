...
export const COMMUNITY_GET_USER_EVENTS = `${API_SERVER}/community/get-user-events`;
export const COMMUNITY_GET_COUNT_POSTS = `${API_SERVER}/community/get-count-posts`;
export const COMMUNITY_GET_COUNT_EVENTS = `${API_SERVER}/community/get-count-events`;
